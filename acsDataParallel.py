...
def get_data(test_size, acs_task, acs_year, acs_states, acs_horizon='1-Year', acs_survey='person', row_start=0,
    ...
    group_functions = []
    group_functions.append(lambda x: x['RAC1P'] == 1)
    group_functions.append(lambda x: x['RAC1P'] == 2)
    group_functions.append(lambda x: x['RAC1P'] == 6)
    group_functions.append(lambda x: x['RAC1P'] == 8)
    group_functions.append(lambda x: x['RAC1P'] == 9)
    group_functions.append(lambda x: ((x['RAC1P'] == 3) | (x['RAC1P'] == 4) | (x['RAC1P'] == 5) | (x['RAC1P'] == 7)))
    ...
    group_functions.append(lambda x: x['SEX'] == 1)
    group_functions.append(lambda x: x['SEX'] == 2)
    ...
    group_functions.append(lambda x: x['AGEP'] < min_age)
    group_functions.append(lambda x: ((x['AGEP'] < mid_age) & (x['AGEP'] >= min_age)))
    group_functions.append(lambda x: x['AGEP'] >= mid_age)
